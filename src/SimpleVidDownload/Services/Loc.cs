...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string[]> S = new()
    {
        ...
        ["capAdBlock"]   = ["Chặn quảng cáo", "Block ads"],
        ["capAdBlockTip"]= ["Chặn quảng cáo, banner và cửa sổ bật ngầm. Trang nào hiện thiếu thì bỏ tick.",
                            "Blocks ads, banners and pop-unders. Untick if a page renders wrong."],
        ["capAdsBlocked"]= ["đã chặn {0} quảng cáo", "{0} ads blocked"],
